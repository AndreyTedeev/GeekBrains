...
namespace MailLibrary.Migrations
{
    ...
    [Migration("20201218101950_Seed-Schedules")]
            ...
            modelBuilder.Entity("MailLibrary.Model.Schedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateTime = new DateTime(2020, 12, 18, 17, 19, 49, 877, DateTimeKind.Local).AddTicks(7748),
                            EmailId = 1,
                            RecipientId = 1,
                            SenderId = 1,
                            ServerId = 1
                        ...
                        {
                            Id = 2,
                            DateTime = new DateTime(2020, 12, 18, 17, 19, 49, 878, DateTimeKind.Local).AddTicks(5643),
                            EmailId = 2,
                            RecipientId = 2,
                            SenderId = 2,
                            ServerId = 2
                        ...
                        {
                            Id = 3,
                            DateTime = new DateTime(2020, 12, 18, 17, 19, 49, 878, DateTimeKind.Local).AddTicks(5658),
                            EmailId = 3,
                            RecipientId = 3,
                            SenderId = 3,
                            ServerId = 3
